...
module tinyriscv_soc_top_with_bridge_downloader_tb;
    ...
    localparam integer PACKET_LEN    = 131;
    localparam integer PAYLOAD_LEN   = 128;
    ...
    task calc_packet_crc;
        ...
        begin
            crc_r = 16'hffff;
            for (pos = 1; pos <= 128; pos = pos + 1) begin
    ...
    task send_first_packet;
        begin
            ...
            packet[61] = fw_size[31:24];
            packet[62] = fw_size[23:16];
            packet[63] = fw_size[15:8];
            packet[64] = fw_size[7:0];
